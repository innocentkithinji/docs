...
description: "Add the Zephlo chatbot widget to any website in minutes"
icon: "puzzle-piece"
---

## Overview

The Zephlo widget is a drop-in chatbot that connects your website visitors to your AI agent. It runs as a [Web Component](https://developer.mozilla.org/en-US/docs/Web/API/Web_components) with full Shadow DOM isolation, so it won't interfere with your existing styles or scripts.
...
That's it. The widget auto-injects itself into the page, fetches its configuration from the Zephlo API, and opens a chat session for each visitor.

### Attributes

| Attribute | Required | Description |
|-----------|----------|-------------|
| `data-chatbot-id` | Yes | Your chatbot's UUID from the dashboard |
...
const zephlo = Zephlo.initialize({
  ...
  chatbotId: "YOUR_CHATBOT_ID",     // required
});
```
